...
namespace vks
{
	namespace initializers
	{
			...
			VkColorComponentFlags colorWriteMask)
		{
			...
			pipelineColorBlendAttachmentState.colorBlendOp = blendOp;
			pipelineColorBlendAttachmentState.alphaBlendOp = blendOp;
			...
			pipelineColorBlendAttachmentState.dstAlphaBlendFactor = dstBlendFactor;
